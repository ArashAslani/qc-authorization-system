...
public class Permission : BaseAuditableEntity, IAggregateRoot
{
    ...
    public string PluginCode { get; private set; } = CoreAccessPermissions.PluginCode;
    public string? Description { get; private set; }

    public static Permission Create(ResourceCatalog resource, ActionCatalog action, string? description = null, string? pluginCode = null)
    {
        ...
        return new Permission
        {
            ...
            Action = action.Code,
            PluginCode = string.IsNullOrWhiteSpace(pluginCode) ? CoreAccessPermissions.PluginCode : pluginCode.Trim().ToUpperInvariant(),
            Description = description,
        };
    }

    public static Permission Create(string code, string resource, string action, string? description = null, string? pluginCode = null)
    {
